...
public class MEnderDragon extends EntityEnderDragon implements MDangerMob {
	
	private short dangerLevel;
	private boolean changed = false;
	
	public MEnderDragon(World world) {
		super(world);
	}
	
	public MEnderDragon(World world, Location spawn) {
		super(world);
		this.changed = true;
